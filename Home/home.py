...
class Home(QMainWindow):
    ...
    def delete_title_msg_backups(self):
        ...
        if self.project_manager.vhdl_check.isChecked():
            ...
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_header_ChatGPT_backup_*.txt"))
            backup_files.append(
                os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_header_ChatGPT_backup.txt"))
        elif self.project_manager.verilog_check.isChecked():
            path = proj_folder + "/Verilog/ChatGPT/Backups"
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_header_ChatGPT_backup_*.txt"))
            backup_files.append(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_header_ChatGPT_backup.txt"))
        if backup_files:
    ...
    def delete_model_msg_backups(self):
        ...
        if self.project_manager.vhdl_check.isChecked():
            path = proj_folder + "/VHDL/ChatGPT/Backups"
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_ChatGPT_backup_*.txt"))
            backup_files.append(os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_ChatGPT_backup.txt"))
        elif self.project_manager.verilog_check.isChecked():
            path = proj_folder + "/Verilog/ChatGPT/Backups"
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_ChatGPT_backup_*.txt"))
            backup_files.append(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_ChatGPT_backup.txt"))
        if backup_files:
            for file in backup_files:
                if os.path.isfile(file):
                    bk = True
    ...
    def delete_testbench_msg_backups(self):
        ...
        if self.project_manager.vhdl_check.isChecked():
            path = proj_folder + "/VHDL/ChatGPT/Backups"
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_TB_ChatGPT_backup_*.txt"))
            backup_files.append(
                os.path.join(path, self.project_manager.get_proj_name() + "_VHDL_TB_ChatGPT_backup.txt"))
        elif self.project_manager.verilog_check.isChecked():
            path = proj_folder + "/Verilog/ChatGPT/Backups"
            backup_files = glob.glob(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_TB_ChatGPT_backup_*.txt"))
            backup_files.append(
                os.path.join(path, self.project_manager.get_proj_name() + "_Verilog_TB_ChatGPT_backup.txt"))
        if backup_files:
            for file in backup_files:
                if os.path.isfile(file):
                    bk = True
